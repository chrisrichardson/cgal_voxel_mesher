...
// Usage:
//
// # Read a raw file (see voreen for example) and use a key value 3 (i.e. voxels
// with value 3 are solid) voxel_mesher -k 3 -i file.dat
//
// # Read a multipage TIFF file as a voxel image, thresholding solid values
// above 128 voxel_mesher -t 128 -i file.tif
//
// Output is in the "medit" format, as this is what CGAL produces. It can be
// converted to other formats using "meshio" or another similar tool.
//
//
...
int main(int argc, char *argv[]) {
  ...
  desc.add_options()("help,h", "describe arguments")(
      ...
      "voxel data file (in .dat or .tif format)")(
      "output,o", po::value<std::string>(),
      "output mesh file (in .mesh format) - defaults to out.mesh")(
      "key,k", po::value<int>(),
      "Pixel value to use as a key (e.g. for segmented image)")(
      "threshold,t", po::value<int>(),
      "Pixel value to threshold from (i.e. values above are solid, use "
      "negative value to set values below as solid)")(
